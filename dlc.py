...
def calc_pose_points():
	...
	try:
		...
		length_cm, width_cm, _, _ = calc_dimensions(snout_x, snout_y, tail_fin_x, tail_fin_y, top_x, top_y, bottom_x, bottom_y)
...
def calc_dimensions(snout_x, snout_y, tail_fin_x, tail_fin_y, top_x, top_y, bottom_x, bottom_y):
